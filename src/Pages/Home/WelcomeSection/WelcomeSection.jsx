        ...
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-1/2">
            ...
            >
              ...
              <path
                fill="#2D3134"
                d="M69.3 196.4l50.2-14-34.6-19.9-17.5 16.9zM261.7 296.2l50.2-14-34.7-19.9-17.5 16.9z"
              ></path>
              <path
                d="M69.3 196.4l50.2-14-34.6-19.9-17.5 16.9zM261.7 296.2l50.2-14-34.7-19.9-17.5 16.9z"
                opacity=".29"
              ...
              <path
                fill="#E5E5E5"
                d="M263.9 237.2c0 .1-83-47.9-82.9-48l-.9-.2c0 .2-69.4-40.6-69.4-40.9l-.9-.1c0 .3-2.4 26.5 7.4 47.3 9.9 20.8 20 34.3 20.1 34.4l.1.1L259 291.4v-.7c0-.3.9-29.6 2.4-37.9 1.5-8.3 3.3-15.3 3.3-15.3l-.8-.3z"
              ></path>
              <path
                fill="#2D3134"
              ...
              <path
                fill="#2D3134"
                d="M102.1 142.6l162.2 94.7s-15.7-69-71.1-96.8-91.1 2.1-91.1 2.1zM169.7 91.4c21.6-10.2 39.2-13.3 39.2-15.4 0-2.1-55.5-4.8-89.8 12.4s-32.6 32-19.6 30.4 30.4-3 35.9-5.7 15.9-13 34.3-21.7z"
              ></path>
              <path
                fill="#656565"
              ...
              <path
                fill="#2D3134"
                d="M241.7 212.9s7.5 3.6 10.9 8.1c3.3 4.5 3.3 6.9 3.3 6.9s-20.8 4.5-31.1-2.1c-10.9-7.1 16.9-12.9 16.9-12.9zM296.4 230.3l3.8-.3 35-17 1.9-3.5 21.3-9.9-.9-1.7-40.7 18.1 1.2 1.5 15.8-7-.9 1-34.2 16.4z"
              ></path>
              <path
                fill="#2D3134"
              ...
              <path
                fill="#E5E5E5"
                d="M408.4 303.2v14.6l26.3-13.1v-14.5z"
              ></path>
              <path
                d="M444.3 264.6s14.3-14.2 13.6-18.2c-.8-4.1-12.5-24.3-14-21.3s-4.7 7.8-3.5 11.9c1.2 4 4.2 23.9 3.9 27.6z"
                opacity=".2"
              ...
              ></path>
              <g fill="#2D3134">
                <path d="M136.9 212v-18.6l6 3.1c2.3 1.2 3.8 2 4.5 2.6 1.1.8 2 1.9 2.7 3.2s1.1 2.7 1.1 4.2c0 1.1-.2 2-.6 2.6-.4.6-.9.9-1.6 1-.6.1-1.3.1-1.9-.1-.9-.3-2.2-.9-3.9-1.7l-2.5-1.2v7l-3.8-2.1zm3.7-13.6v5.3l2.1 1c1.5.8 2.5 1.2 3 1.2.5.1.9 0 1.2-.3.3-.3.4-.7.4-1.2 0-.7-.2-1.3-.6-2-.4-.6-.9-1.2-1.5-1.6-.4-.3-1.4-.8-2.7-1.5l-1.9-.9zM153.5 211.2c0-1.9.3-3.3.9-4.3.4-.7 1-1.3 1.7-1.7.7-.4 1.5-.5 2.4-.5 1.2.1 2.5.5 4 1.3 2.7 1.4 4.9 3.4 6.6 5.9 1.6 2.5 2.5 5.3 2.5 8.4 0 3-.8 4.9-2.5 5.8s-3.8.6-6.6-.8-5-3.4-6.6-5.9c-1.6-2.5-2.4-5.2-2.4-8.2zm3.8 1.9c0 2.1.5 4 1.5 5.5 1 1.6 2.2 2.8 3.7 3.5 1.5.8 2.7.8 3.7.3 1-.6 1.4-2 1.4-4.1 0-2.1-.5-4-1.4-5.5s-2.2-2.7-3.7-3.5-2.8-.9-3.7-.3c-1 .6-1.5 1.9-1.5 4.1zM174.6 231.2v-18.5l3.8 1.9v15.3l9.3 4.8v3.1l-13.1-6.6zM190.2 239.1v-18.6l3.8 1.9V241l-3.8-1.9zM209.5 242.1l3.6 3c-.6 1.7-1.5 2.8-2.8 3.1-1.3.3-2.9 0-4.9-1-2.5-1.3-4.5-3.1-6.1-5.6-1.6-2.5-2.4-5.2-2.4-8.1 0-3.1.8-5.1 2.4-6 1.6-.9 3.7-.7 6.3.6 2.3 1.2 4.1 2.8 5.5 4.8.8 1.2 1.5 2.7 1.9 4.4l-3.7-1c-.2-1.1-.7-2.1-1.4-3-.7-.9-1.5-1.6-2.5-2.1-1.4-.7-2.5-.8-3.4-.2-.9.6-1.3 1.9-1.3 4.2 0 2.4.4 4.2 1.3 5.7.8 1.4 1.9 2.5 3.3 3.2 1 .5 1.9.6 2.6.4.7-.5 1.3-1.2 1.6-2.4zM216.3 252.4v-18.6l13.8 7v3.1l-10-5.1v4.1l9.3 4.8v3.1l-9.3-4.8v5.1l10.4 5.3v3.1l-14.2-7.1z"></path>
              </g>
              <path
                ...
                opacity=".11"
              ></path>
              <path fill="#2D3134" d="M212 131l58-30-22-11-59 29z"></path>
              <path
                fill="#39C"
                d="M210 100l-15.5 7.8c-2.7 1.4-4.5 4.2-4.5 7.2 0 3.1 1.7 5.9 4.5 7.2l11.9 6c2.3 1.1 5 1.1 7.2 0L230 120v-10l-20-10z"
              ></path>
              <path
                fill="#CC291F"
                d="M265.5 87.8l-11.9-6c-2.3-1.1-5-1.1-7.2 0L230 90l20 10v10l15.5-7.8c2.7-1.4 4.5-4.2 4.5-7.2 0-3.1-1.7-5.9-4.5-7.2z"
              ></path>
              <path
                fill="#E5E5E5"
                d="M230 90l-20 10 20 10v10l20-10v-10z"
              ></path>
              <path
                d="M230 110v10l20-10v-10zM250 100v10l15.5-7.8c2.7-1.4 4.5-4.2 4.5-7.2 0-1.6-.5-3.1-1.3-4.4L250 100zM210 120v9c1.2 0 2.5-.3 3.6-.9L230 120v-10l-20 10z"
                opacity=".29"
              ></path>
              <path
                d="M191.3 110.6c-.8 1.3-1.3 2.8-1.3 4.4 0 3.1 1.7 5.9 4.5 7.2l11.9 6c1.1.6 2.4.9 3.6.9v-9l-18.7-9.5z"
                opacity=".11"
              ></path>
              <path
                fill="#FFF"
                d="M192 111l18 9 20-10-20 8zM250 100l17-9 1-1-17-9 15 9z"
                opacity=".8"
              ></path>
            </svg>
          </div>
          ...
          <div className="lg:w-1/2 lg:pl-12 flex flex-col justify-center">
            ...
            <p className="text-gray-700 mb-6">
              Explore our various sections to discover informative articles,
              helpful guides, engaging multimedia content, and much more. Our
              dedicated team is committed to delivering high-quality and
              up-to-date information to keep you informed and entertained.
            </p>
            <ul className="mb-6">
            ...
            <div>
              <button className="btn hover:bg-blue-600 bg-blue-500 border-none mr-5">
                Get Started
              </button>
            </div>
          </div>
